...
export const author_post = mysqlTable(
  "post_auhtor",
  {
    post_id: int("post_id")
      .notNull()
...
export const post_category = mysqlTable(
  "post_category",
  {
    post_id: int("post_id")
      .notNull()
...
export const notifications = mysqlTable("notifications", {
  notification_id: int("notification_id").autoincrement().primaryKey(),
  payload: json("payload").notNull().$type<PushSubscriptionJSON>(),
});
